...
-- CreateIndex
CREATE UNIQUE INDEX "ExpertScore_userId_tagId_key" ON "ExpertScore"("userId", "tagId");
...
-- AddForeignKey
ALTER TABLE "ExpertScore" ADD CONSTRAINT "ExpertScore_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ExpertScore" ADD CONSTRAINT "ExpertScore_tagId_fkey" FOREIGN KEY ("tagId") REFERENCES "Tag"("id") ON DELETE CASCADE ON UPDATE CASCADE;
